...
const getBatchingExecutor = memoize2of3(function (_context, subschemaConfig, executor) {
    var _a, _b, _c;
    const loader = new DataLoader(createLoadFn(executor !== null && executor !== void 0 ? executor : subschemaConfig.executor, (_b = (_a = subschemaConfig.batchingOptions) === null || _a === void 0 ? void 0 : _a.extensionsReducer) !== null && _b !== void 0 ? _b : defaultExtensionsReducer), (_c = subschemaConfig.batchingOptions) === null || _c === void 0 ? void 0 : _c.dataLoaderOptions);
