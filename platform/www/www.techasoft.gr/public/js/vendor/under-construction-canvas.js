...
* =======================================================
*
*  @Doc Description: techasoft web site Custom Under Constraction Canvas
*  @Author: d4rth0nyx
...
canvas.style.background = "#1f2534";
...
function tick(){
  for (var i = 0; i < techasoft_logoPerTick; i++) {
    var techasoft_logo = new createjs.Bitmap("images/techasoft-symbol.svg");
